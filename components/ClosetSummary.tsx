...
export default function ClosetSummary({
  ...
  // Cart shows a per-wall top-down layout for L/U closets; straight closets and
  // every other location keep the front-elevation sketch.
  const useWalls = layout === 'walls' && config.shape !== 'straight';
  const svg = useWalls ? cartLayoutSvg(catalog, config) : closetSketchSvg(catalog, config);
